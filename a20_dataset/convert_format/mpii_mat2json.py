...
MPII_DATASET_ROOT = "/home/weixing/temp/mpii"
...
def split_train_test():
    ...
    all_data = open(os.path.join(MPII_OUT_DIR, 'mpii_human_pose_v1_u12_1.json')).readlines()
    N = len(all_data)
    N_test = int(N * 0.1)
    N_train = N - N_test
