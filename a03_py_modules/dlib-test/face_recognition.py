...
if len(sys.argv) != 4:
    ...
    exit()
# python face_recognition.py D:/weights/dlib/shape_predictor_68_face_landmarks.dat D:/weights/dlib/dlib_face_recognition_resnet_model_v1.dat D:/dataset/faces/lfw/Aaron_Peirsol
