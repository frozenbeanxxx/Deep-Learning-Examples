...
if len(sys.argv) != 5:
    ...
    exit()
# python face_clustering.py D:/weights/dlib/shape_predictor_5_face_landmarks.dat D:/weights/dlib/dlib_face_recognition_resnet_model_v1.dat D:/dataset/faces/lfw/Aaron_Peirsol ./result
