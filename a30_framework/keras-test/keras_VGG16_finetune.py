...
model_vgg = VGG16(include_top=False, weights='D:\\Software\\weights\\keras/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5', input_shape=(48, 48, 3))#输入进来的数据是48*48 3通道
...
#以下是原版的模型结构 224*224
model_vgg = VGG16(include_top=False, weights='D:\\Software\\weights\\keras/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5', input_shape=(224, 224, 3))
for layer in model_vgg.layers:
    layer.trainable = False#别去调整之前的卷积层的参数
...
(X_train, y_train), (X_test, y_test) = mnist.load_data("D:\\dataset\\mnist/mnist.npz")
